...
|---|---:|---:|
| 朝 | 04:45 JST | 07:20 JST |
| 昼 | 09:45 JST | 12:20 JST |
| 夜 | 16:45 JST | 19:20 JST |
...
- 200-400字目安、最大500字。
- 1行目はニュース・ソース名で始めない。私の迷い、失敗、怖さ、気づきから入る。
- 基本構成は「私の具体場面 → 最新情報は根拠として1つ → 気づき → 答えやすい問い」。
- 問いは二択、経験ある/ない、具体場面など、答えの入口を置く。
- 必ず問いかけで締める。
- 一人称「私」。
- 絵文字0-1個。
- 体験・失敗・気づきを主役にする。
...
- 3カラム固定を避け、悩み→気づき、Before/After、選択肢、詰まり→解消フローを混ぜること
...
- 文字ブロックは最大5つ。大見出しは読者の痛み・葛藤・あるあるに寄せる
